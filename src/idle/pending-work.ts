 ...
 * refill, a due auto purchase, or a higher-priority job already in the cursor queue), so
 * idle play / the dance must stop at once. Mirrors the scheduler's priorities: this is the
 * ONE place that logic lives, injected into the scheduler and idle/happy-dance so they can
