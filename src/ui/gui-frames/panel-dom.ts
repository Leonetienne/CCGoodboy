...
<div id="ccsb-body">
    ...
    <details class="ccsb-advanced" id="ccsb-hud-details">
        <summary>Details owo</summary>
        <div class="ccsb-row">
    ...
    <div class="ccsb-buttons" id="ccsb-more">
    ...
    <div id="ccsb-settings">
        <div class="ccsb-settings-title">Basic :3</div>
        ...
        <details class="ccsb-advanced">
            ...
            <label style="display:flex;gap:6px;align-items:center;margin-top:5px" title="Shows the Debug tools button under More (cheats for testing: use a test save)">
                <input id="ccsb-show-debug" type="checkbox">
                Show debug tools (cheats) owo
            </label>
        </details>
